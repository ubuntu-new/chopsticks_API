        ...
        success: function (result) {
            ...
            $.each(result["woocommerce"], function( index, value ){
                ...
                if (phpData.userid == 4 || phpData.userid == 6) {
                    ...
                    if (branchAddress.indexOf($branch) > 0) {
                    cnt++;
                    // item += "<div># "+value.id+"</div>";
                    $.each(value.line_items, function (key, items) {
                ...
                if (val["source"] == 'woocommerce') {
                    ...
                    text += ' <div class="blockDiv  aab col-sm-4 col-lg-3">' +
                        ...
                        '<div class="row m-t-10">' +
                            ...
                            "<div class='col-6 m-t-10'><button class='updateOrder btn btn-success waves-effect waves-light' data-status='3' data-orderid='"+val.id+"'>Box <i class='ion-arrow-right-a'></i>   </button></div>" +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>';
